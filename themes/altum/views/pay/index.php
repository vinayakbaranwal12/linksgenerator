                                        ...
                                        <div class="card-body d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="">
                                                <div class="d-flex align-items-center">
                                                    <span id="monthly_price_amount" class="custom-radio-box-main-text"><?= nr($data->plan->monthly_price, 2) ?></span>
                                    ...
                                    <div class="card">
                                        <div class="card-body d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span id="annual_price_amount" class="custom-radio-box-main-text"><?= nr($data->plan->annual_price, 2) ?></span>
                                                <span class="ml-1"><?= settings()->payment->currency ?></span>
                                            </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span id="lifetime_price_amount" class="custom-radio-box-main-text"><?= nr($data->plan->lifetime_price, 2) ?></span>
                                                <span class="ml-1"><?= settings()->payment->currency ?></span>
                                            </div>
...
<script>
    ...
    let check_payment_processor = () => {
        ...
        if(['offline_payment', 'coinbase', 'payu', 'crypto_com', 'paddle', 'mercadopago', 'yookassa'].includes(payment_processor)) {
            $('#recurring_type_label').hide();
            $('#one_time_type_label').show();
        }

            ...
            <div>
                <?php if($this->user->plan_settings->domains_limit != -1 && $data->total_domains >= $this->user->plan_settings->domains_limit): ?>
                    <button type="button" class="btn btn-primary disabled" data-toggle="tooltip" title="<?= l('global.info_message.plan_feature_limit') ?>">
                        <i class="fa fa-fw fa-sm fa-plus-circle"></i> <?= l('domains.create') ?>
                    </button>
                <?php else: ?>
                    <a href="<?= url('domain-create') ?>" class="btn btn-primary"><i class="fa fa-fw fa-sm fa-plus-circle"></i> <?= l('domains.create') ?></a>
                <?php endif ?>
            </div>
            ...
            <div class="d-flex custom-row align-items-center my-4" data-domain-id="<?= $row->domain_id ?>">
                ...
                <div class="col-6 col-lg-3">
                    <?php if($row->is_enabled): ?>
                        <span class="badge badge-success"><i class="fa fa-fw fa-sm fa-check mr-1"></i> <?= l('domains.table.is_enabled_active') ?></span>
                    <?php else: ?>
                        <span class="badge badge-warning"><i class="fa fa-fw fa-sm fa-eye-slash mr-1"></i> <?= l('domains.table.is_enabled_pending') ?></span>
                    <?php endif ?>
                </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-column align-items-center justify-content-center py-3">
                    <img src="<?= ASSETS_FULL_URL . 'images/no_rows.svg' ?>" class="col-10 col-md-7 col-lg-4 mb-3" alt="<?= l('domains.no_data') ?>" />

    ...
    <table class="table table-custom">
        ...
        <?php foreach($data->affiliates_withdrawals as $row): ?>
            <tr>
                ...
                <td class="text-nowrap">
                    <?php if($row->is_paid): ?>
                        <span class="badge badge-success"><i class="fa fa-fw fa-sm fa-check mr-1"></i> <?= l('admin_affiliates_withdrawals.table.is_paid_paid') ?></span>
                    <?php else: ?>
                        <span class="badge badge-warning"><i class="fa fa-fw fa-sm fa-eye-slash mr-1"></i> <?= l('admin_affiliates_withdrawals.table.is_paid_pending') ?></span>
                    <?php endif ?>
                </td>

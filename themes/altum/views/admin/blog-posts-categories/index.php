...
<?php if(count($data->blog_posts_categories) || count($data->filters->get)): ?>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between mb-4">
        <h1 class="h3 mb-3 mb-md-0"><i class="fa fa-fw fa-xs fa-map text-primary-900 mr-2"></i> <?= l('admin_blog_posts_categories.header') ?></h1>

        <div class="d-flex position-relative">
            <div class="">
                <a href="<?= url('admin/blog-posts-category-create') ?>" class="btn btn-primary"><i class="fa fa-fw fa-plus-circle"></i> <?= l('admin_blog_posts_categories.create') ?></a>
            </div>
                    ...
                    <tr>
                        ...
                        <td class="text-nowrap">
                            <span class="badge badge-light">
                                <i class="fa fa-fw fa-sm fa-language mr-1"></i> <?= $row->language ?? l('global.all') ?>
                            </span>
                        </td>

...
<div class="d-flex flex-column flex-md-row justify-content-between mb-4">
    <h1 class="h3 mb-3 mb-md-0"><i class="fa fa-fw fa-xs fa-comments text-primary-900 mr-2"></i> <?= l('admin_chats.header') ?></h1>
                ...
                <td class="text-nowrap">
                    <div class="d-flex align-items-center">
                        ...
                        <span class="mr-2" data-toggle="tooltip" data-html="true" title="<?= l('chats.used_tokens') . '<br />' . nr($row->used_tokens) ?>">
                            <i class="fa fa-fw fa-code-branch text-muted"></i>
                        </span>
                    </div>
                </td>

...
<div class="d-flex justify-content-between mb-4">
    <h1 class="h3 mb-0 text-truncate"><i class="fa fa-fw fa-xs fa-paperclip text-primary-900 mr-2"></i> <?= l('admin_tax_update.header') ?></h1>
...
<div class="card <?= \Altum\Alerts::has_field_errors() ? 'border-danger' : null ?>">
    <div class="card-body">
        <form action="" method="post" role="form">
            ...
            <div class="form-group">
                <label for="description"><i class="fa fa-fw fa-sm fa-pen text-muted mr-1"></i> <?= l('admin_taxes.main.description') ?></label>
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        <label for="value"><i class="fa fa-fw fa-sm fa-percentage text-muted mr-1"></i> <?= l('admin_taxes.main.value') ?></label>
                ...
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        <label for="value_type"><i class="fa fa-fw fa-sm fa-list-ol text-muted mr-1"></i> <?= l('admin_taxes.main.value_type') ?></label>
            ...
            <div class="form-group">
                <label for="type"><i class="fa fa-fw fa-sm fa-fingerprint text-muted mr-1"></i> <?= l('admin_taxes.main.type') ?></label>
            ...
            <div class="form-group">
                <label for="billing_type"><i class="fa fa-fw fa-sm fa-receipt text-muted mr-1"></i> <?= l('admin_taxes.main.billing_type') ?></label>
            ...
            <div class="form-group">
                <label for="countries"><i class="fa fa-fw fa-sm fa-flag text-muted mr-1"></i> <?= l('global.countries') ?></label>

...
<?php if(count($data->pages) || count($data->filters->get)): ?>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between mb-4">
        <h1 class="h3 mb-3 mb-md-0"><i class="fa fa-fw fa-xs fa-copy text-primary-900 mr-2"></i> <?= l('admin_pages.header') ?></h1>

        <div class="d-flex position-relative">
            <div class="">
                <a href="<?= url('admin/page-create') ?>" class="btn btn-primary"><i class="fa fa-fw fa-plus-circle"></i> <?= l('admin_pages.create') ?></a>
            </div>

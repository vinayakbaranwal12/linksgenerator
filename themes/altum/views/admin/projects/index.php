...
<div class="d-flex flex-column flex-md-row justify-content-between mb-4">
    <h1 class="h3 mb-3 mb-md-0"><i class="fa fa-fw fa-xs fa-project-diagram text-primary-900 mr-2"></i> <?= l('admin_projects.header') ?></h1>
                    ...
                    <td class="text-nowrap">
                        <div class="d-flex align-items-center">
                            ...
                            <a href="<?= url('admin/transcriptions?project_id=' . $row->project_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('transcriptions.title') ?>">
                                <i class="fa fa-fw fa-microphone-alt text-muted"></i>
                            </a>
                            <?php endif ?>
                        </div>
                    </td>

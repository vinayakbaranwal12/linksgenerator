    ...
    <div class="card-body">
        ...
        <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input id="biolink_block_border_width" type="number" min="0" max="5" class="form-control" name="biolink_block_border_width" value="<?= $data->values['biolink_block_border_width'] ?>" required="required" />
            </div>

    ...
    <div class="card-body">
        ...
        <form action="" method="post" role="form">
            ...
            <div class="form-group">
                ...
                <input id="custom_index_url" type="text" name="custom_index_url" class="form-control" placeholder="<?= l('admin_domains.main.custom_index_url_placeholder') ?>" />
            ...
            <div class="form-group">
                ...
                <input id="custom_not_found_url" type="text" name="custom_not_found_url" class="form-control" placeholder="<?= l('admin_domains.main.custom_not_found_url_placeholder') ?>" />

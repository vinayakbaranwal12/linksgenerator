...
<?php if(count($data->codes) || count($data->filters->get)): ?>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between mb-4">
        <h1 class="h3 mb-3 mb-md-0"><i class="fa fa-fw fa-xs fa-tags text-primary-900 mr-2"></i> <?= l('admin_codes.header') ?></h1>

        <div class="d-flex position-relative">
            <div class="">
                <a href="<?= url('admin/code-create') ?>" class="btn btn-primary"><i class="fa fa-fw fa-plus-circle"></i> <?= l('admin_codes.create') ?></a>
            </div>
                        ...
                        <td class="text-nowrap">
                            <div class="d-flex align-items-center">
                                <a href="<?= url('admin/redeemed-codes?code_id=' . $row->code_id) ?>" class="badge badge-light mr-2" data-toggle="tooltip" title="<?= l('admin_redeemed_codes.menu') ?>">
                                    <i class="fa fa-fw fa-sm fa-tags text-muted mr-1"></i>
                                    <?= nr($row->redeemed) ?>
                                </a>

...
<div class="d-flex flex-column flex-md-row justify-content-between mb-4">
    <h1 class="h3 mb-3 mb-md-0"><i class="fa fa-fw fa-xs fa-link text-primary-900 mr-2"></i> <?= l('admin_links.header') ?></h1>
...
<form id="table" action="<?= SITE_URL . 'admin/links/bulk' ?>" method="post" role="form">
    ...
    <table class="table table-custom">
        ...
        <?php foreach($data->links as $row): ?>
            <?php //CODE:DEMO if(DEMO) {$row->user_email = 'hidden@demo.com'; $row->user_name = 'hidden on demo';} ?>
            <tr>
                    ...
                    <div class="d-flex flex-column">
                        <div>
                            ...
                            <?php if($row->type == 'biolink' && $row->is_verified): ?>
                                <span data-toggle="tooltip" title="<?= l('link.biolink.verified') ?>"><i class="fa fa-fw fa-xs fa-check-circle link-verified" style="color: #0086ff"></i></span>
                            <?php endif ?>
                        </div>
                ...
                <td class="text-muted">
                    <span class="badge badge-light"><i class="fa fa-fw fa-sm fa-chart-bar mr-1"></i> <?= nr($row->clicks) ?></span>
                </td>
                <td class="text-nowrap">

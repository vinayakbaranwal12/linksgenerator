...
<div class="d-flex flex-column flex-md-row justify-content-between mb-4">
    <h1 class="h3 mb-3 mb-md-0"><i class="fa fa-fw fa-xs fa-scroll text-primary-900 mr-2"></i> <?= l('admin_users_logs.header') ?></h1>
    ...
    <div class="table-responsive table-custom-container">
        <table class="table table-custom">
            ...
            <?php foreach($data->users_logs as $row): ?>
                <?php //CODE:DEMO if(DEMO) {$row->user_email = 'hidden@demo.com'; $row->user_name = $row->ip = 'hidden on demo';} ?>
                <tr>

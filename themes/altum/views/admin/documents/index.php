...
<div class="d-flex flex-column flex-md-row justify-content-between mb-4">
    <h1 class="h3 mb-3 mb-md-0"><i class="fa fa-fw fa-xs fa-robot text-primary-900 mr-2"></i> <?= l('admin_documents.header') ?></h1>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right filters-dropdown">
                    ...
                    <form action="" method="get" role="form">
                        ...
                        <div class="form-group px-4">
                            <label for="filters_template_id" class="small"><?= l('documents.type') ?></label>
    ...
    <div class="table-responsive table-custom-container">
        <table class="table table-custom">
            ...
            <?php foreach($data->documents as $row): ?>
                <?php //CODE:DEMO if(DEMO) {$row->user_email = 'hidden@demo.com'; $row->user_name = $row->name = 'hidden on demo';} ?>
                ...
                <tr>
                    ...
                    <td class="text-nowrap">
                        ...
                        <span class="mr-2" data-toggle="tooltip" data-html="true" title="<?= l('documents.words') . '<br />' . nr($row->words) ?>">
                            <i class="fa fa-fw fa-feather text-muted"></i>
                        </span>
                            ...
                            <i class="fa fa-fw fa-tachometer-alt text-muted"></i>
                        </span>
                        </div>
                    </td>

            ...
            <div class="modal-body">
                <form name="create_link" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="link_location_url"><i class="fa fa-fw fa-link fa-sm text-muted mr-1"></i> <?= l('create_link_modal.input.location_url') ?></label>
                        <input id="link_location_url" type="text" class="form-control" name="location_url" maxlength="2048" required="required" placeholder="<?= l('create_link_modal.input.location_url_placeholder') ?>" />
                    </div>

                    <div class="form-group">
                        <label for="link_url"><i class="fa fa-fw fa-bolt fa-sm text-muted mr-1"></i> <?= l('create_link_modal.input.url') ?></label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="create_biolink" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="biolink_url"><i class="fa fa-fw fa-bolt fa-sm text-muted mr-1"></i> <?= l('link.settings.url') ?></label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <?php if(count($data->domains)): ?>
                                    <select name="domain_id" class="appearance-none custom-select form-control input-group-text">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="create_file" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="file_file"><i class="fa fa-fw fa-sm fa-file text-muted mr-1"></i> <?= l('create_file_modal.input.file') ?></label>
                    ...
                    <div class="form-group">
                        <label for="file_url"><i class="fa fa-fw fa-bolt fa-sm text-muted mr-1"></i> <?= l('create_link_modal.input.url') ?></label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <?php if(count($data->domains)): ?>
                                    <select name="domain_id" class="appearance-none custom-select form-control input-group-text">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="create_file" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="vcard_url"><i class="fa fa-fw fa-bolt fa-sm text-muted mr-1"></i> <?= l('link.settings.url') ?></label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <?php if(count($data->domains)): ?>
                                    <select name="domain_id" class="appearance-none custom-select form-control input-group-text">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="create_event" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="event_url"><i class="fa fa-fw fa-bolt fa-sm text-muted mr-1"></i> <?= l('link.settings.url') ?></label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <?php if(count($data->domains)): ?>
                                    <select name="domain_id" class="appearance-none custom-select form-control input-group-text">

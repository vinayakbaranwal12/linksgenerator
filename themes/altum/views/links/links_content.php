    ...
    <div class="col-12 col-lg-auto d-flex">
        <div>
            <?php if(isset($data->filters->filters['type'])): ?>
                <button type="button" data-toggle="modal" data-target="<?= '#create_' . $data->filters->filters['type'] ?>" class="btn btn-primary">
                    <i class="fa fa-fw fa-plus-circle"></i> <?= l('link.' . $data->filters->filters['type'] . '.name') ?>
                </button>
            <?php else: ?>
                <div class="dropdown">
        ...
        <div class="ml-3">
            <a href="<?= url('biolinks-templates') ?>" class="btn btn-outline-primary">
                <i class="fa fa-fw fa-moon fa-sm mr-1"></i> <?= l('biolinks_templates.menu') ?>
            </a>
        </div>
                        ...
                        <div class="d-flex flex-column min-width-0">
                            <div class="d-inline-block text-truncate">
                                ...
                                <?php if($row->type == 'biolink' && $row->is_verified): ?>
                                    <span data-toggle="tooltip" title="<?= l('link.biolink.verified') ?>"><i class="fa fa-fw fa-xs fa-check-circle" style="color: #0086ff"></i></span>
                                <?php endif ?>
                            </div>
                            <div class="d-flex align-items-center">

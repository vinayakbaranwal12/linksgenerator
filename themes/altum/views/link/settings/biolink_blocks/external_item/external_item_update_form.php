...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="form-group">
        ...
        <input id="<?= 'external_item_location_url_' . $row->biolink_block_id ?>" type="text" class="form-control" name="location_url" value="<?= $row->location_url ?>" maxlength="2048" placeholder="<?= l('create_biolink_link_modal.input.location_url_placeholder') ?>" />
    </div>

...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="collapse" id="<?= 'button_settings_container_' . $row->biolink_block_id ?>">
        ...
        <div class="form-group">
            ...
            <select id="<?= 'mail_animation_' . $row->biolink_block_id ?>" name="animation" class="custom-select">
        ...
        <div class="form-group">
            ...
            <select id="<?= 'mail_animation_runs_' . $row->biolink_block_id ?>" name="animation_runs" class="custom-select">

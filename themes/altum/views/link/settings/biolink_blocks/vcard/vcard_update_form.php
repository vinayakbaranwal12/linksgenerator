...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="collapse" id="<?= 'vcard_settings_container_' . $row->biolink_block_id ?>">
        ...
        <div class="form-group">
            <label for="<?= 'vcard_email_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-envelope fa-sm text-muted mr-1"></i> <?= l('global.email') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'vcard_city_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-city fa-sm text-muted mr-1"></i> <?= l('global.city') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'vcard_country_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-globe fa-sm text-muted mr-1"></i> <?= l('global.country') ?></label>

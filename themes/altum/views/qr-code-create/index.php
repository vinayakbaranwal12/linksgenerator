                ...
                <div class="card-body">
                    <form action="" method="post" role="form" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <div class="form-group" data-type="vcard">
                                <label for="vcard_city"><i class="fa fa-fw fa-city fa-sm text-muted mr-1"></i> <?= l('global.city') ?></label>
                            ...
                            <div class="form-group" data-type="vcard">
                                <label for="vcard_country"><i class="fa fa-fw fa-globe fa-sm text-muted mr-1"></i> <?= l('global.country') ?></label>
                        ...
                        <button class="btn btn-block btn-gray-300 my-4" type="button" data-toggle="collapse" data-target="#style_container" aria-expanded="false" aria-controls="style_container">
                            <i class="fa fa-fw fa-qrcode fa-sm mr-1"></i> <?= l('qr_codes.input.style') ?>
                        </button>

                        <div class="collapse" id="style_container">
                            <div class="form-group">
                                <label for="style"><i class="fa fa-fw fa-qrcode fa-sm text-muted mr-1"></i> <?= l('qr_codes.input.style') ?></label>
                                <div class="row btn-group-toggle" data-toggle="buttons">
                                    <?php foreach(['square' => 'fa fa-square-full', 'dot' => 'fa fa-circle', 'round' => 'fa fa-square', 'heart' => 'fa fa-heart', 'diamond' => 'fa fa-gem'] as $key => $icon): ?>
                                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="inner_eye_style"><i class="fa fa-fw fa-circle fa-sm text-muted mr-1"></i> <?= l('qr_codes.input.inner_eye_style') ?></label>
                                <div class="row btn-group-toggle" data-toggle="buttons">
                                    <?php foreach(['square' => 'fa fa-square-full', 'dot' => 'fa fa-circle', 'rounded' => 'fa fa-square', 'diamond' => 'fa fa-gem', 'flower' => 'fa fa-seedling', 'leaf' => 'fa fa-leaf'] as $key => $icon): ?>
                                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="outer_eye_style"><i class="fa fa-fw fa-dot-circle fa-sm text-muted mr-1"></i> <?= l('qr_codes.input.outer_eye_style') ?></label>
                                <div class="row btn-group-toggle" data-toggle="buttons">
                                    <?php foreach(['square' => 'fa fa-square-full', 'circle' => 'fa fa-circle', 'rounded' => 'fa fa-square', 'flower' => 'fa fa-seedling', 'leaf' => 'fa fa-leaf'] as $key => $icon): ?>
                                        <div class="col-6">

...
class AdminUsersLogs extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['user_id'], ['type', 'ip'], ['datetime']));
        ...
        /* Export handler */
        process_export_json($users_logs, 'include', ['user_id', 'type', 'ip', 'continent_code', 'country_code', 'city_name', 'device_type', 'datetime']);
        process_export_csv($users_logs, 'include', ['user_id', 'type', 'ip', 'continent_code', 'country_code', 'city_name', 'device_type', 'datetime']);

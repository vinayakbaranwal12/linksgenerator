...
class AdminSettings extends Controller {
    ...
    public function cookie_consent() {
        ...
        if(isset($_GET['export']) && $_GET['export'] == 'csv') {
            //CODE:DEMO if(DEMO) exit('This command is blocked on the demo.');
    ...
    public function license() {
        ...
        if(!empty($_POST) && !empty($_POST['new_license'])) {
            ...
            $altumcode_api = 'https://api.hypweb.in/validate';
    ...
    public function support() {
        ...
        if(!empty($_POST)) {
            ...
            $altumcode_api = 'https://api.hypweb.in';
    ...
    public function aix() {
        //CODE:DEMO if(DEMO) settings()->aix->openai_api_key = 'not shown on the demo';
        $this->process();
        ...
        if(!empty($_POST)) {
            ...
            /* Uploads processing */
            settings()->aix->chats_avatar = \Altum\Uploads::process_upload(settings()->aix->chats_avatar, 'chats_avatar', 'chats_avatar', 'chats_avatar_remove', null);

...
return [
    ...
    'admin_plans.plan.documents_limit' => 'AI Documents limit',
    ...
    'admin_user_view.signatures' => 'Signatures',
    'admin_user_view.documents' => 'Documents',
    'admin_user_view.images' => 'Images',
    'admin_user_view.transcriptions' => 'AI Transcriptions',
    'admin_user_view.chats' => 'AI Chats',
    ...
    'admin_settings.documentation' => 'Donate us via PayPal <a href="https://paypal.me/baranwalvinayak">Here</a>',
    ...
    'admin_settings.license.license_help' => 'The General License for using our tool.',
    ...
    'admin_settings.support.status.active.help' => 'You are eligible for receiving support via contact@hypweb.in',
    ...
    'admin_settings.links.favicon_size_limit' => 'Biolink favicon size limit',
    ...
    'admin_settings.aix.chats_assistant_name' => 'Assistant name',
    'admin_settings.aix.chats_avatar' => 'Assistant avatar',
    ...
    'admin_languages.info_message.main' => 'The main language will always be replaced with releases of new updates. If you want to avoid this, Read the documentation FAQ.',
    ...
    'admin_broadcast_update.error_message.processing' => 'You can not update a broadcast while it is processing.',
    ...
    'admin_biolinks_templates.main.link_id_help' => 'Write the ID of an already existing biolink page that will reflect the template settings and blocks.',
    ...
    'admin_templates_categories.main.icon' => 'Icon',
    'admin_templates_categories.main.icon_placeholder' => 'fa fa-bolt',
    'admin_templates_categories.main.icon_help' => '<a href="https://fontawesome.com/v5/search?m=free" target="_blank">FontAwesome</a> icon class, leave empty for no icon.',
    ...
    'admin_templates.main.description' => 'Description',
    ...
    'admin_templates.main.prompt_help' => 'This is the prompt that will get sent to OpenAI API. You can use <code>{key}</code> variables based on the key value of your dynamic inputs.',
    'admin_templates.main.icon' => 'Icon',
    'admin_templates.main.icon_placeholder' => 'fa fa-bolt',
    'admin_templates.main.icon_help' => '<a href="https://fontawesome.com/v5/search?m=free" target="_blank">FontAwesome</a> icon class, leave empty for no icon.',
